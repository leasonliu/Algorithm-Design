public class Fibonacci_NoTimeCal {
    ...
    public static void main(String[] args) {
        int[] n = {0, 1, 5, 10, 14, 17, 25, 30, 35};
        for (int i = 0; i < n.length; i++) {
            System.out.println("Recursive(" + n[i] + "): " + fib_recursive(n[i]));
        }
        for (int i = 0; i < n.length; i++) {
            System.out.println("Iterative(" + n[i] + "): " + fib_iterative(n[i]));
        }
    }
}
